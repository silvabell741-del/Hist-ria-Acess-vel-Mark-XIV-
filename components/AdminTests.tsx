...
const AdminTests: React.FC = () => {
    ...
    return (
        <div className="space-y-8">
            <div>
                <h1 className="text-3xl font-bold text-slate-800 dark:text-slate-100 hc-text-primary">Painel de Performance</h1>
                <p className="text-slate-500 dark:text-slate-400 mt-1 hc-text-secondary">Bateria de testes de sanidade e performance do Frontend + Firebase.</p>
            </div>
