    ...
    return (
        <div className="space-y-8">
             <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
                <div>
                    <h2 className="text-3xl font-bold text-slate-800 dark:text-slate-100 hc-text-primary">Gerenciar Quizzes</h2>
                    <p className="text-slate-500 dark:text-slate-400 mt-1 hc-text-secondary">Visualize e gerencie todos os quizzes do sistema</p>
                </div>
                <button 
