    ...
    return (
        ...
        >
            <button 
                ...
                disabled={scale <= 0.75}
                className="px-2 py-0.5 rounded text-lg font-bold disabled:opacity-50 text-slate-700 dark:text-slate-200 hover:bg-slate-200 dark:hover:bg-slate-700"
                aria-label="Diminuir zoom"
            >
                -
            </button>
            <span 
                className="w-12 text-center text-sm font-semibold text-slate-700 dark:text-slate-200 tabular-nums"
                aria-live="polite"
            >
            ...
            <button 
                onClick={resetScale} 
                className="px-2 py-0.5 rounded text-sm font-semibold text-slate-700 dark:text-slate-200 hover:bg-slate-200 dark:hover:bg-slate-700"
