...
const AdminStats: React.FC = () => {
    ...
    return (
        <div className="space-y-8">
            <div>
                <h1 className="text-3xl font-bold text-slate-800 dark:text-slate-100">Estatísticas de Conteúdo</h1>
                <p className="text-slate-500 dark:text-slate-400 mt-1">Visão geral da base de conhecimento da plataforma.</p>
            </div>
