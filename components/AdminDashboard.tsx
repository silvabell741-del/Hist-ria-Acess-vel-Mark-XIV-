...
const WelcomeBanner: React.FC = () => {
    ...
    return (
        <div className="p-8 rounded-xl bg-gradient-to-r from-slate-800 to-slate-900 text-white shadow-lg hc-bg-override hc-border-override">
            <h1 className="text-3xl font-bold hc-text-override">Painel do Administrador</h1>
            <p className="mt-2 opacity-90 hc-text-override">Olá, {user?.name || 'Admin'}! Gerencie o conteúdo público da plataforma.</p>
        </div>
    );
};
